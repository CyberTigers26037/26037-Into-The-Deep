...
/* This constant is the number of encoder ticks for each degree of rotation of the arm.
    ...
    final double ARM_SCORE_SPECIMEN_HIGH_CHAMBER_BACKWARDS    =   54 * ARM_TICKS_PER_DEGREE; //auto
    ...
    final double VIPERSLIDE_HIGH_CHAMBER_BACKWARDS            = 105 * VIPERSLIDE_TICKS_PER_MM; // auto
