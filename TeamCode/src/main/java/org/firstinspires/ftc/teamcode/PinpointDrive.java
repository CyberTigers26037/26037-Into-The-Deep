...
public class PinpointDrive extends MecanumDrive {
    public static class Params {
        ...
        public double xOffsetMM = RobotConfig.getxPinpointOffsetMM();
        public double yOffsetMM = RobotConfig.getyPinpointOffsetMM();
    ...
    public PinpointDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        pinpoint.setOffsets(PARAMS.xOffsetMM, PARAMS.yOffsetMM);
